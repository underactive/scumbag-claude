...
- [ ] **Broken symlink cleanup action** — `isBrokenSymlink` flag is shown visually (red icon) but there's no dedicated action to clean up broken symlinks specifically.
